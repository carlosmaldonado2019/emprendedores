...
<form  id="login" method="POST">
  ...
  <div class="form-group">
    <input type="password" class="form-control" id="contrasenia" aria-describedby="emailHelp" placeholder="Contraseña">
    <small id="fileHelp" class="form-text text-muted">¿Olvidaste tu contraseña? Presiona <a href="recuperacionCuenta.php">aquí</a></small>
  </div>
