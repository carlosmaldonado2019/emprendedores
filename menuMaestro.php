...
<!-- -Zona de recursos externos- -->
	...
	<body>
		<section class="main-header navbar-fixed-top">
			...
			<nav id="menuMaestro" class="navbar navbar-default" role="navigation">
		    	<div class="container">
			    	...
			    	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				    	<ul class="nav navbar-nav navbar-center" id="navbar">
					        ...
					        <li><a href="editarMaestro.php"><strong >MI INFORMACIÓN</strong></a></li>
		                    <li><a href="registroEquipo.php"><strong >REGISTRAR EQUIPO</strong></a></li>
					        <li><a href="equiposMaestro.php"><strong >MIS EQUIPOS</strong></a></li>
					        ...
					        <li><a href="logOut.php"><strong onmouseover="this.innerHTML='CERRAR SESION';" onmouseleave="this.innerHTML='<img src=imagenes/who.png><?= $_SESSION['nombre'];?>';"><img src="imagenes/who.png"><?= $_SESSION['nombre'];?></strong></a></li>
