...
$html="<meta charset='utf-8'>
		...
		<p>
			<img style='width:780px;height:240px;' src='imagenes/Constancia Equipos 2018-2 Header.JPG'>
		</p>
		<div style='margin-left:170px;width:480px;text-align:center;font-size:22px;'>
			 $nombreEmpresa
		</div
		<p>
			<img style='width:780px;height:275px;' src='imagenes/Constancia Equipos 2018-2 Footer.JPG'>
		</p>";
